...
std::pair<torch::Tensor, torch::Tensor> get_batch(torch::Tensor W_target, torch::Tensor b_target, int64_t batch_size = 32) {
...
int main() {
	...
	std::cout << "Loss: " << loss << " after " << batch_index << " batches" << std::endl;
